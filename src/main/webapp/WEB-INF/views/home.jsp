    ...
    <div class="row paddingHome my-2">
        ...
        <div class="col height position-relative p-0">
            <div class="container position-absolute top-50 start-50 translate-middle">
                <div class="color2 p-2 mb-2 rounded min translate-middle-x">
                    <h1 class="p-2 ">Ecovis</h1>
                </div>
                <div class="color2 p-2 mt-2 rounded min translate-middle-x">
                ...
                <div class="color2 p-2 mt-2 rounded d-grid gap-2 min translate-middle-x">
                    <a class="btn color2" href="<c:url value="/nouvelles"/> ">Se connecter</a>
                </div>
            </div>
        ...
        <div class="col height position-relative p-0">
            <img src="/images/ocg-saving-the-ocean-cyxRGU7keTw-unsplash.jpg" class=" back rounded image2 position-absolute top-50 start-50 translate-middle" alt="...">
        </div>
    </div>
</div>
</body>
